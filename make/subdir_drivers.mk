...
Drivers/STM32F1xx_HAL_Driver/Src/%.o: ../Drivers/STM32F1xx_HAL_Driver/Src/%.c
	...
	@echo $(PWD)
	arm-none-eabi-gcc -mcpu=cortex-m3 -mthumb -mfloat-abi=soft '-D__weak=__attribute__((weak))' -DARM_MATH_CM3 '-D__packed=__attribute__((__packed__))' -DUSE_HAL_DRIVER -DSTM32F103x6 -I"H:/Martin/STM_Projekte/EBiCS_Firmware/Inc" -I"H:/Martin/STM_Projekte/EBiCS_Firmware/Drivers/STM32F1xx_HAL_Driver/Inc" -I"H:/Martin/STM_Projekte/EBiCS_Firmware/Drivers/STM32F1xx_HAL_Driver/Inc/Legacy" -I"H:/Martin/STM_Projekte/EBiCS_Firmware/Drivers/CMSIS/Device/ST/STM32F1xx/Include" -I"H:/Martin/STM_Projekte/EBiCS_Firmware/Drivers/CMSIS/Include" -I"C:/CMSIS_5-develop/CMSIS_5-develop/CMSIS//Include"  -Og -g3 -Wall -fmessage-length=0 -ffunction-sections -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -o "$@" "$<"
