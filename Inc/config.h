...
#define I_FACTOR_I_Q 0.005L			//integral factor for PI control of iq
...
#define OFFSET_A 965 				//Offset of current sensing phase A
#define OFFSET_B 933				//Offset of current sensing phase B
